...
export const SeoConfigContract = {
  ...
  Create: t.Object(t.Omit(t.Object(SeoConfigBase.insertFields), ["id", "createdAt", "updatedAt"]).properties),
  Update: t.Partial(t.Omit(t.Object(SeoConfigBase.insertFields), ["id", "createdAt", "updatedAt", "siteId"])),
  ListQuery: t.Object({
  ...
  ListResponse: t.Object({ data: t.Array(t.Object(SeoConfigBase.fields)), total: t.Number() }),
} as const;
